...
void GLApplication::initialize() {
	...
	/*VertexTexture vertices[8] = {
	 ...
	 { glm::vec3(0.5f, -0.5f, 0.5f), glm::vec2(1.0f, 0.0f) }, // 3
	 { glm::vec3(0.5f, -0.5f, -0.5f), glm::vec2(0.0f, 1.0f) }, // 4
	 { glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec2(0.0f, 1.0f) }, // 5
...
void GLApplication::applicationLoop() {
	...
	while (processInput) {
		...
		model = glm::rotate(model, (GLfloat) timeValue * 5.0f,
